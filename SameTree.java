...
public class SameTree {
	...
	public boolean isSameTree2(TreeNode p, TreeNode q) {
		...
		if (p != null) st_p.push(p);
		if (q != null) st_q.push(q);
		...
		while (!st_p.isEmpty() && !st_q.isEmpty()) {
			...
			if (pt.left != null) st_p.push(pt.left);
			if (qt.left != null) st_q.push(qt.left);
			
			if (st_p.size() != st_q.size()) return false;
			
			if (pt.right != null) st_p.push(pt.right);
			if (qt.right != null) st_q.push(qt.right);
